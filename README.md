...
더미 상품 20개는 매일 한국시간 `00:05`에 갱신됩니다. 1번 상품은 `01:00`, 이후 상품은
1시간 간격으로 판매를 시작해 20번 상품은 `20:00`에 시작합니다. 각 상품의 예약 마감은
판매 시작 23시간 55분 후입니다(예: 20번 상품은 다음 날 `19:55` 마감). 20개 상품은 모두
`ACTIVE` 상태로 등록·노출되며, 상품별 판매 시작·마감 시각 값만 다르게 설정됩니다.
