...
public class FrontendApiController {
    ...
    @PostMapping("/api/seller/settlements") public ResponseEntity<ApiResponseTemplate<SettlementResponse>> settle(@AuthenticationPrincipal Long userId,@RequestBody SettlementRequest body){return ApiResponseTemplate.success(service.settle(userId,body));}
