...
public class DummyProductSeeder {
    ...
    /** LoremFlickr는 태그와 매칭되는 무료 사진을 돌려주므로, 상품 내용에 맞는 영어 키워드를 태그로 사용한다. */
    private void ensureProductImage(Long productId, String keywords) {
        String imageUrl = "https://loremflickr.com/800/600/"
